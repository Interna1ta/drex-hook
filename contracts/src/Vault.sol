...
contract Vault is Ownable, ReentrancyGuard, EIP712 {
    ...
    function publishAttestation(
        ...
        require(serviceManager.isActiveOperator(msg.sender), Vault__InvalidAVSOperator());

        BridgeRequestData memory request = s_bridgeRequests[
            _bridgeRequestId
        ];
        ...
        attestations[_bridgeRequestId].push(Attestation(msg.sender, _signature));
    ...
    function releaseFunds(
        ...
        BridgeRequestData memory storedData = s_bridgeRequests[
            bridgeRequestId
        ];
        require(
